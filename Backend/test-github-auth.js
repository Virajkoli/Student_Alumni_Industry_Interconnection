...
async function testGitHubRoutes() {
  ...
  try {
    ...
    console.log('Cannot test programmatically, but endpoint should be accessible.');
    ...
    console.log('This would fail with 404 "User not found" if the user does not exist');
    ...
    console.log('Note: These routes require an actual GitHub OAuth flow to fully test.');
