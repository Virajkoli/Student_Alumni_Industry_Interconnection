  ...
  const [learningResources, setLearningResources] = useState([
    {
      ...
      size: "15.2 MB",
      pages: "450 pages",
      description: "Comprehensive guide covering machine learning algorithms, implementation, and real-world applications.",
    ...
    },
    {
      ...
      stars: "12.5K total",
      description: "Collection of well-documented data science projects covering various domains and techniques.",
    ...
    },
    {
      ...
      description: "Comprehensive study notes covering system design patterns, scalability, and architecture principles.",
    ...
    },
    {
      ...
      description: "Interactive coding platform with real-time feedback, automated testing, and peer collaboration.",
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="mt-1" style={{ color: "#1F2D3D", opacity: "0.7" }}>
            Gain insights from industry leaders and access valuable learning materials
          </p>
        </div>
        <button
        ...
        >
          ...
          <span>{activeTab === "interviews" ? "Add Interview" : "Add Resource"}</span>
        </button>
      </div>
          ...
          <div className="rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto" style={{ backgroundColor: "white" }}>
            <div className="p-6 border-b" style={{ borderColor: "#B5D3E7" }}>
              <div className="flex justify-between items-center">
                ...
                >
                  <X className="w-5 h-5" style={{ color: "#1F2D3D", opacity: "0.7" }} />
                </button>
              </div>
            </div>
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold mb-2" style={{ color: "#1F2D3D" }}>
                      {interview.title}
                    </h3>
                    <div className="flex items-center space-x-4 text-sm mb-3" style={{ color: "#1F2D3D", opacity: "0.7" }}>
                    ...
                    <p className="text-sm mb-1" style={{ color: "#1F2D3D", opacity: "0.7" }}>{interview.role}</p>
                  </div>
                  <button
                ...
                <p className="mb-4 leading-relaxed" style={{ color: "#1F2D3D", opacity: "0.8" }}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4 text-sm" style={{ color: "#1F2D3D", opacity: "0.6" }}>
                ...
                <div className="mt-4 pt-4 border-t" style={{ borderColor: "#B5D3E7" }}>
          ...
          {learningResources.map((resource) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3">
                  {resource.type === "E-book/PDF" && <FileText className="w-6 h-6" style={{ color: "#6EA9CB" }} />}
                  {resource.type === "Video Tutorial" && <Video className="w-6 h-6" style={{ color: "#6EA9CB" }} />}
                  {resource.type === "GitHub Links" && <Github className="w-6 h-6" style={{ color: "#6EA9CB" }} />}
                  {resource.type === "Study Notes" && <BookOpen className="w-6 h-6" style={{ color: "#6EA9CB" }} />}
                  {resource.type === "Practice Platform" && <Monitor className="w-6 h-6" style={{ color: "#6EA9CB" }} />}
                  <div>
              ...
              <h3 className="text-lg font-semibold mb-2" style={{ color: "#1F2D3D" }}>
                {resource.title}
              </h3>

              <div className="space-y-2 mb-4 text-sm" style={{ color: "#1F2D3D", opacity: "0.7" }}>
                {resource.author && (
              ...
              <p className="mb-4 leading-relaxed text-sm" style={{ color: "#1F2D3D", opacity: "0.8" }}>
              ...
              <div className="flex items-center justify-between mb-4 text-sm" style={{ color: "#1F2D3D", opacity: "0.6" }}>
              ...
              <div className="flex space-x-3">
                <button 
                  ...
                  onMouseLeave={(e) => e.target.style.backgroundColor = "#6EA9CB"}
                >
                  {resource.type === "E-book/PDF" && <FileText className="w-4 h-4" />}
                  {resource.type === "Video Tutorial" && <Play className="w-4 h-4" />}
                  {resource.type === "GitHub Links" && <Github className="w-4 h-4" />}
                  {resource.type === "Study Notes" && <BookOpen className="w-4 h-4" />}
                  {resource.type === "Practice Platform" && <Monitor className="w-4 h-4" />}
                  <span>
