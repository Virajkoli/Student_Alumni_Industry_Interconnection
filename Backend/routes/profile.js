...
router.delete('/experience/:id', auth, studentProfileController.deleteExperience);
...
router.post('/certifications', auth, studentProfileController.createCertification);
router.put('/certifications/:id', auth, studentProfileController.updateCertification);
router.delete('/certifications/:id', auth, studentProfileController.deleteCertification);

// Recommendations routes
router.get('/recommendations', auth, studentProfileController.getRecommendations);
router.post('/recommendations', auth, studentProfileController.createRecommendation);
router.put('/recommendations/:id', auth, studentProfileController.updateRecommendation);
router.delete('/recommendations/:id', auth, studentProfileController.deleteRecommendation);
