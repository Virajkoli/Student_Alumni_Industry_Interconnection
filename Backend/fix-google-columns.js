...
async function fixGoogleColumns() {
  try {
    ...
    const queries = [
      {
        name: "Students.google_id",
        sql: 'ALTER TABLE "Students" ADD COLUMN "google_id" VARCHAR(255);',
      },
      {
      ...
      {
        name: "Colleges.google_id",
        sql: 'ALTER TABLE "Colleges" ADD COLUMN "google_id" VARCHAR(255);',
      },
      {
    ...
    const [results] = await sequelize.query(`
      ...
      AND column_name IN ('google_id', 'imageUrl')
    ...
    console.log(
      '   ALTER TABLE "Colleges" ADD COLUMN "google_id" VARCHAR(255);'
    );
    console.log(
