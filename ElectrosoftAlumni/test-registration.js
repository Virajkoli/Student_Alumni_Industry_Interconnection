...
const testRegistration = async () => {
  ...
  try {
    ...
    const debugResponse = await fetch("https://scaips-backend.onrender.com/api/auth/debug-register", {
      method: "POST",
      headers: {
    ...
    const response = await fetch("https://scaips-backend.onrender.com/api/auth/register", {
      method: "POST", 
      headers: {
        "Content-Type": "application/json",
      },
