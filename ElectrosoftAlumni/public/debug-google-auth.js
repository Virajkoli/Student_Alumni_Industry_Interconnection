...
window.debugGoogleAuth = {
    ...
    // Simulate Google OAuth response with debugging
    ...
    checkStoredData() {
        ...
        console.log('📦 Stored Google user:', googleUser ? JSON.parse(googleUser) : null);
        console.log('🔑 Stored access token:', accessToken ? 'YES' : 'NO');
        
        return { googleUser: googleUser ? JSON.parse(googleUser) : null, accessToken };
    },
