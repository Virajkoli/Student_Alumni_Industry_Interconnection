    ...
    <>
      ...
      <div className="bg-white rounded-xl shadow p-6 mb-6">
        ...
        <div>
          ...
          {collegeData.customFields && collegeData.customFields.length > 0 && (
            <div className="mt-6">
      ...
      <div className="bg-white rounded-xl shadow p-6 mb-6">
        <div className="flex justify-between items-start mb-4">
          <h2 className="text-xl font-bold text-blue-900">Campuses</h2>
          <button
          ...
          >
            ...
            {collegeData.campuses.map((campus, index) => (
              <Marker key={index} position={campus.coordinates}>
                <Popup maxWidth={220} minWidth={220} className="compact-popup">
                  <div className="p-1">
                    <div className="flex items-start gap-2 mb-2">
                      <img
                        src={campus.image}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleCampusChange(index, "students", e.target.value)
                        }
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                        ...
                        {campus.customFields.map((field) => (
                          ...
                          >
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                handleRemoveCampusCustomField(index, field.id)
                              }
