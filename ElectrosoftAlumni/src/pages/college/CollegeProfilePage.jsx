        ...
        return (
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2 text-base leading-7">
                <li>450+ highly qualified faculty members</li>
                <li>Many with international research experience</li>
                <li>Regular guest lectures by global experts</li>
              </ul>
            </div>
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-gray-700 text-base">
                ...
                <div>Humanities & Social Sciences</div>
                <div>Management Sciences</div>
                <div>Biological Sciences & Bioengineering</div>
              </div>
            </div>
            <div>
              <h3 className="font-semibold text-blue-800 mb-2 text-lg">Faculty Achievements</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-2 text-base leading-7">
                <li>Numerous awards and recognitions at national and international levels</li>
                <li>Fellowships from national and international academies</li>
                <li>Extensive research publications and patents</li>
              </ul>
            </div>
          </div>
        );
