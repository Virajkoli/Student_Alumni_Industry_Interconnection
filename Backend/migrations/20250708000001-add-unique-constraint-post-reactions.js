...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      console.log('Successfully added unique constraints to post_reactions table');
    } catch (error) {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      await queryInterface.removeConstraint('post_reactions', 'unique_post_student_reaction');
      await queryInterface.removeConstraint('post_reactions', 'unique_post_college_reaction');
      await queryInterface.removeConstraint('post_reactions', 'unique_post_industry_reaction');
      await queryInterface.removeConstraint('post_reactions', 'unique_post_alumni_reaction');
      await queryInterface.removeConstraint('post_reactions', 'unique_post_startup_reaction');

      console.log('Successfully removed unique constraints from post_reactions table');
    } catch (error) {
