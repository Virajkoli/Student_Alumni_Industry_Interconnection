            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <p className="text-sm text-gray-600 mb-4">
                  Toggle navigation items to show/hide them from your profile navigation.
                </p>
                  ...
                  <div key={item.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <button
                      ...
                      className={`w-12 h-6 rounded-full transition-colors duration-200 ${
                        hiddenNavItems.includes(item.id) ? 'bg-gray-300' : 'bg-blue-500'
                      }`}
                    >
                      <div className={`w-4 h-4 bg-white rounded-full transition-transform duration-200 ${
                        hiddenNavItems.includes(item.id) ? 'translate-x-1' : 'translate-x-7'
                      }`} />
                    </button>
                  </div>
                ))}
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-lg font-semibold text-gray-900">
                  {isEditingCustomNav ? 'Edit Custom Section' : 'Add Custom Section'}
                </h3>
                <button
                  onClick={() => {
                    setIsNewNavModalOpen(false);
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setNewNavData(prev => ({ ...prev, name: e.target.value }))
                    }
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewNavData(prev => ({ ...prev, contentType: e.target.value }))
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  >
                    <option value="text">Text Content</option>
                    <option value="structured">Structured Content</option>
                ...
                <div>
                  ...
                  <textarea
                    value={typeof newNavData.content === 'string' ? newNavData.content : (newNavData.content?.content || '')}
                    onChange={(e) => setNewNavData(prev => ({ ...prev, content: e.target.value }))
                    }
                    rows={6}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              ...
              <div className="flex justify-end space-x-3 mt-6">
                ...
                <button
                  onClick={isEditingCustomNav ? handleUpdateCustomNav : handleCreateCustomNav}
                  className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200"
                >
                  {isEditingCustomNav ? 'Update' : 'Create'}
                </button>
              </div>
            </div>
          </div>
