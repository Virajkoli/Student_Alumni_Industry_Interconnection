    ...
    <div className="max-w-2xl mx-auto p-6">
      ...
      {isAuthenticated ? (
        <div className="mb-4 p-4 bg-green-100 rounded">
          ...
          <p>Role: {user.role}</p>
          {user.imageUrl && (
            <img src={user.imageUrl} alt="Profile" className="w-12 h-12 rounded-full mt-2" />
          )}
        </div>
      ) : (
      ...
      <div className="mt-6 p-4 bg-gray-100 rounded">
        ...
        <p>Google Client ID: 120148362755-dmisbc1usk06heg33nan4cklovcreqm6.apps.googleusercontent.com</p>
