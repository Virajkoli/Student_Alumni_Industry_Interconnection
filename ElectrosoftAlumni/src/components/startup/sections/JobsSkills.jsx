...
const JobsSkills = () => {
  ...
  const handleEditItem = (index, category) => {
    setEditingItemIndex({ index, category });
  };

  const handleSaveItem = (index, updatedItem, category) => {
    const newContent = { ...content };
    if (category === 'trending') {
      newContent.categories.trending.skills[index] = updatedItem;
    } else if (category === 'jobs') {
      newContent.categories.jobs.jobs[index] = updatedItem;
    } else if (category === 'learning') {
      newContent.categories.learning.paths[index] = updatedItem;
    }
  ...
  const updateItem = (index, field, value, category) => {
    const newContent = { ...content };
    if (category === 'trending') {
