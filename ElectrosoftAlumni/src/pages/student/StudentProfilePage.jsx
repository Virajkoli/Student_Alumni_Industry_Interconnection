    ...
    try {
      ...
      if (response.success) {
        ...
        setProfileData({
          ...
          additionalName: "",
          pronouns: "",
          headline: data.basicInfo.interested_field || "Student",
          industry: "Education",
          school: data.basicInfo.college_name || "",
          showSchool: true,
          country: "India",
          city: "", // This can be added to backend later
          about: data.about || "",
          email: data.basicInfo.email || "",
          contact_no: data.basicInfo.contact_no || "",
          college_name: data.basicInfo.college_name || "",
